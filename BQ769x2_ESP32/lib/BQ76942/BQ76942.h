...
public:
     ...
     * 
     * @param _bqAddres Direccion i2c del BMS
     * 
    */
    ...
    /**
     * @brief
     * Esta funcion permite inicializar todos los elementos necesarios para el correcto funcionamiento del 
     * integrado BQ76942.
     * 
    */
    void begin();
    ...
    */
     ...
     * 
     * @param reg   Registro en el cual se va a posicionar.
