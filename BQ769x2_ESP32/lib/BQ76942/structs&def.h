...
struct _readEnableProtectionsA_bits
{
    bool SCD    = 0;
    bool OCD2   = 0;
    bool OCD1   = 0;
    ...
    _readEnableProtectionsA_bits(uint8_t x){
        SCD     = x & 0b10000000;
        OCD2    = x & 0b01000000;
        OCD1    = x & 0b00100000;
        OCC     = x & 0b00010000;
...
//Alertas, estado y protecciones B
struct _safetyAlertB_bits
{
    bool OTF     = 0;
    bool OTINT   = 0;
    bool OTD     = 0;
...
struct _readEnableProtectionsB_bits
{
    bool OTF     = 0;
    bool OTINT   = 0;
    bool OTD     = 0;
    ...
    _readEnableProtectionsB_bits(uint8_t x){
        OTF     = x & 0b10000000;
        OTINT   = x & 0b01000000;
        OTD     = x & 0b00100000;
        OTC     = x & 0b00010000;
...
//----------------------------------DEFINICIONES----------------------------------
//Data	Memory	registers	Name in TRM ( for access this use subCommands functions )
...
#define MaxCellTemp 0x9337      //Settings:Cell Balancing Config:Cell Temp			
